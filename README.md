...
<a href="https://star-history.dera.page/#TalexDreamSoul/sub2api&Date">
 <picture>
   <source media="(prefers-color-scheme: dark)" srcset="https://star-history.dera.page/svg?repos=TalexDreamSoul/sub2api&type=Date&theme=dark" />
   <source media="(prefers-color-scheme: light)" srcset="https://star-history.dera.page/svg?repos=TalexDreamSoul/sub2api&type=Date" />
   <img alt="Star History Chart" src="https://star-history.dera.page/svg?repos=TalexDreamSoul/sub2api&type=Date" />
 </picture>
</a>

...
func init() {
	...
	usagelogDescSpeedWaitMs := usagelogFields[35].Descriptor()
	...
	userDescAPIKeyMaxActiveIps := userFields[23].Descriptor()
	...
	userDescAPIKeyMaxActiveIpsVisible := userFields[24].Descriptor()

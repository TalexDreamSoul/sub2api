...
func (r *userRepository) Update(ctx context.Context, userIn *service.User, fields service.UserUpdateFields) error {
	...
	updated := existing
	entityFields := fields.Email || fields.Username || fields.Notes || fields.PasswordHash ||
		fields.Role || fields.Status || fields.Concurrency || fields.RPMLimit ||
		fields.SignupSource || fields.LastLoginAt || fields.LastActiveAt ||
		fields.BalanceNotifySettings || fields.BalanceNotifyExtraEmails
	if entityFields {

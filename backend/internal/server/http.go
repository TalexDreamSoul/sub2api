...
func ProvideRouter(
	...
	return SetupRouter(r, handlers, jwtAuth, optionalJWTAuth, adminAuth, apiKeyAuth, auditLog, stepUpAuth, apiKeyService, subscriptionService, apiKeyRuntimeService, opsService, settingService, compositeResolver, cfg, redisClient)
}

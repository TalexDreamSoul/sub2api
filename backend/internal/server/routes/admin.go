...
func registerSettingsRoutes(admin *gin.RouterGroup, h *handler.Handlers, stepUpAuth middleware.StepUpAuthMiddleware) {
	adminSettings := admin.Group("/settings")
	{
		...
		adminSettings.GET("/feishu-assistant/config", h.Admin.Setting.GetFeishuAssistantConfig)
		adminSettings.PUT("/feishu-assistant/config", middleware.RequireStepUpAlways(stepUpAuth), h.Admin.Setting.UpdateFeishuAssistantConfig)
		adminSettings.POST("/feishu-assistant/test", middleware.RequireStepUpAlways(stepUpAuth), h.Admin.Setting.TestFeishuAssistantModel)
		adminSettings.GET("/feishu-assistant/api-key-requests", h.Admin.Setting.ListFeishuAPIKeyRequests)
		adminSettings.POST("/feishu-assistant/api-key-requests/:id/decision", middleware.RequireStepUpAlways(stepUpAuth), h.Admin.Setting.DecideFeishuAPIKeyRequest)
		adminSettings.GET("/feishu-assistant/admins", h.Admin.Setting.ListFeishuAssistantAdmins)
		adminSettings.POST("/feishu-assistant/admins", middleware.RequireStepUpAlways(stepUpAuth), h.Admin.Setting.AddFeishuAssistantAdmin)
		adminSettings.DELETE("/feishu-assistant/admins/:user_id", middleware.RequireStepUpAlways(stepUpAuth), h.Admin.Setting.RemoveFeishuAssistantAdmin)
		adminSettings.GET("/feishu-assistant/chats", h.Admin.Setting.ListFeishuChatBindings)
		adminSettings.PUT("/feishu-assistant/chats/:id", middleware.RequireStepUpAlways(stepUpAuth), h.Admin.Setting.UpdateFeishuChatBinding)

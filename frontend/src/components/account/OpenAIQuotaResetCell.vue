...
const confirmReset = async () => {
  ...
  try {
    ...
    // Prefer the authoritative post-reset quota snapshot the server refreshed
    // inline. If it could not be read back, report the count as unknown instead
    // of letting a second consumption start from stale data.

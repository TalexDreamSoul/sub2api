export default {
    accounts: {
      ...
      ollamaCloud: {
        ...
        encryptionKeyRequired: 'Save a persistent encryption key in Admin Settings > Security and restart the service before storing a browser session. TOTP_ENCRYPTION_KEY deployment configuration remains supported.',
      ...
      resetQuotaConfirm: 'Reset local quota usage for “{name}”. This action cannot be undone.',
      restoreSubscriptionUsage: 'Also refund usage produced by this account in the current daily, weekly, and monthly subscription windows',
      resetQuotaRefundPending: 'Account quota reset; subscription usage refund is pending',
      ...
      usageWindow: {
        ...
        activeQuery: 'Query',
        localObserved: 'Local traffic',
        limitNotConfigured: 'No local quota limit configured',
        upstreamUsageUnavailable: 'Upstream usage API unavailable'
      },
      openaiQuotaReset: {
        count: 'Credits',
        reset: 'Reset',
        ...
        resetReplay: 'This reset was already completed; no additional reset credit was consumed',
        refundPending: 'Upstream reset succeeded; subscription usage refund is pending',
        restoreSubscriptionUsage: 'Also refund usage produced by this account in the current daily, weekly, and monthly subscription windows',

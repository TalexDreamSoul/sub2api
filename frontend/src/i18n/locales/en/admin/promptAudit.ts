export default {
  promptAudit: {
    ...
    errors: {
      ...
      prompt_audit_encryption_key_required: 'No fixed encryption key is active, so audit node API keys would be lost on restart. Save a key in Admin Settings > Security and restart the service; TOTP_ENCRYPTION_KEY deployment configuration remains supported.',

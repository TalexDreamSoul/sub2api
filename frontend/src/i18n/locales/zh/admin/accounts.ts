export default {
    accounts: {
      ...
      resetQuota: '重置配额',
      resetQuotaConfirm: '将重置账号“{name}”的本站配额用量。此操作不可撤销。',
      restoreSubscriptionUsage: '同时返还该账号在当前订阅日/周/月窗口内实际产生的用量',
      resetQuotaRefundPending: '账号配额已重置，订阅用量返还处理中',
      quotaLimit: '配额限制',
      ...
      usageWindow: {
        ...
        activeQuery: '查询',
        localObserved: '本站调用',
        limitNotConfigured: '未配置本站额度上限',
        upstreamUsageUnavailable: '上游未提供用量接口'
      },
      openaiQuotaReset: {
        count: '次数',
        reset: '重置',
        ...
        resetReplay: '该重置操作已完成，本次未重复消耗重置次数',
        refundPending: '上游已重置，订阅用量返还处理中',
        restoreSubscriptionUsage: '同时返还该账号在当前订阅日/周/月窗口内实际产生的用量',

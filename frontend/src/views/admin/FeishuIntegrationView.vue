    ...
    <div class="mx-auto w-full max-w-6xl space-y-6 px-4 py-6 sm:px-6">
      ...
      <section v-if="activeTab === 'config'" class="space-y-5">
        ...
        <div class="grid gap-4 md:grid-cols-2">
          ...
          <label class="field"><span>{{ tx('事件与回调 Verification Token', 'Events and callbacks Verification Token') }}</span><input v-model="form.verificationToken" type="password" class="input" autocomplete="new-password" :placeholder="secretPlaceholder(settings?.feishu_notify_verification_token_configured)" /></label>
